...
export const PERMISSIONS: Record<string, string> = {
    ...
    'activities.list': 'View activity feed',
    'activities.view_all': 'View all user activities',
};
...
export const PERMISSION_CATEGORIES: Record<string, string[]> = {
    ...
    'Payments': ['payments.list', 'payments.view', 'payments.create', 'payments.update', 'payments.delete'],
    ...
    'Activity': ['activities.list', 'activities.view_all'],
};
