...
export default function DashboardPage() {
  ...
  return (
    <Can permission="dashboard.view" fallback={<div className="flex h-[calc(100vh-64px)] items-center justify-center text-muted-foreground">You do not have permission to view the dashboard.</div>}>
