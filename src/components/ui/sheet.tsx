...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card/95 backdrop-blur-lg border-white/10 p-6 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
